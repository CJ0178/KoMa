...
public class ComplaintService {
    ...
    public ApiResponse<ComplaintDTO> createComplaint(ComplaintDTO request) {
        ...
        PropertyModel property = propertyRepository.findById(request.getPropertyId()).orElseThrow(() -> new CustomExceptions(HttpStatus.NOT_FOUND, "Property tidak ditemukan", null));
